...
public class CameraActivity extends Activity implements WebRtcClient.RtcListener {
...
//        fullscreenRenderer.setEnableHardwareScaler(true /* enabled */);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            report("sljfsdklfjdlskjlk  >=");
            startScreenCapture();
        } else {
            report("FFFFFFFFFFFFFFFF");
            init();
        }
    }
...
//        mWebRtcClient = new WebRtcClient(getApplicationContext(), this, pipRenderer, fullscreenRenderer, createScreenCapturer(), peerConnectionParameters);
        mWebRtcClient = new WebRtcClient(getApplicationContext(), this, createVideoCapturer(), peerConnectionParameters);
    }
